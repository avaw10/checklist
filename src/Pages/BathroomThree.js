...
import bathThreeStyles from "../Styles/baththreeclean.module.css";
...
function BathThree() {
  ...
  const loadData = async () => {
    const url = "http://localhost:4001/bathroomThree";
    const resp = await fetch(url);
    const data = await resp.json();
    console.log("bathroomThree data", data);
  ...
  return (
    <Layout isLoggedIn={true}>
      <div className={bathThreeStyles.container}>
        <div className={bathThreeStyles.intro}>
          <div className={bathThreeStyles.top}>
            <h57>Bathroom Three's Chores!</h57>
            <div className={bathThreeStyles.under}>
              <h58>
                Check what chores are done, need to be done, who they were
                completed by, and when they were completed!
              </h58>
              <div className={bathThreeStyles.week}>
                <h59> Week of: {weekOf} </h59>
                <div className={bathThreeStyles.baththree}>
                  <table>
                    <tr>
                      <th>Chore</th>
                      <th>Completed By</th>
                ...
                <button
                  className={bathThreeStyles.subbutton}
                  onClick={submitData}>
                  Submit
                </button>
              </div>
